...
set colorcolumn=0 " don't display colored column at these line lengths
...
nnoremap <leader>,local_dev :-1read $EditorDir/plugged/vim-options/snippets/python/local_dev.py<CR>/jump<CR>
